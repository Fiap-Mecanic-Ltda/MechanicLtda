...
namespace MechanicLtda.Infrastructure.Migrations
{
    ...
    [Migration("20260913165438_AddDataAlteracaoStatusOrdemServico")]
    partial class AddDataAlteracaoStatusOrdemServico
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.Estoque", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.ItemOrdemServico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.Orcamento", b =>
                {
                    ...
                    b.Property<decimal>("ValorTotalInsumos")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.OrdemServico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.OrdemServicoAprovacaoToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("OrdemServicoAprovacaoTokens", (string)null);
                });
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.Veiculo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.ItemOrdemServico", b =>
                {
                    b.HasOne("MechanicLtda.Domain.Entities.Estoque", "Estoque")
                        .WithMany("ItensOrdemServico")
                        .HasForeignKey("EstoqueId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("MechanicLtda.Domain.Entities.OrdemServico", "OrdemServico")
                        .WithMany("ItensOrdemServico")
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.Orcamento", b =>
                {
                    b.HasOne("MechanicLtda.Domain.Entities.OrdemServico", "OrdemServico")
                        .WithOne("Orcamento")
                        .HasForeignKey("MechanicLtda.Domain.Entities.Orcamento", "OrdemServicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MechanicLtda.Domain.Entities.OrdemServico", b =>
                {
                    b.HasOne("MechanicLtda.Domain.Entities.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MechanicLtda.Domain.Entities.Veiculo", "Veiculo")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MechanicLtda.Domain.Entities.Usuario", null)
                        .WithMany()
